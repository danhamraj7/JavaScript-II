...
//for their running bibs. Combine both the first and last names and 
//populate a new array called `fullNames`. This array will contain just 
//strings.

//I Need to loop through the array and find first and last names of 
//the runners.
...
//uppercase because the director BECAME DRUNK WITH POWER. Populate an 
//array called `firstNamesAllCaps`. This array will contain just strings.
...
//issue. We need a filtered version of the runners array, 
//containing only those runners with large sized shirts so they 
//can choose a different size. This will be an array of objects.
...
//Add up all the donations and save the total into a ticketPriceTotal 
//variable.
...
// Problem 1
//The director wants to know the names of the companies that were
...
// Problem 2
// The director does not like how the companies look. He now wants it in 
//upper case.

let comNamesAllCaps = [];
const comNameAllCaps = runners.map(function (item) {
  return item.company_name.toUpperCase();
});
console.log(comNameAllCaps);


// Problem 3
// The director thinks he ordered to much small  shirts. He wants to 
// know the names of the participants who wears small shirts.
